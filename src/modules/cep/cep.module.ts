    ...
    BrasilApiProvider,
    {
      ...
      useFactory: (
        ...
        const options = {
          ...
          resetTimeout: configService.get('CB_RESET_TIMEOUT_MS', {
            infer: true,
          }),
          timeout: configService.get('CEP_PROVIDER_TIMEOUT_MS', {
            infer: true,
          }),
          volumeThreshold: configService.get('CB_VOLUME_THRESHOLD', {
            infer: true,
          }),
        };
